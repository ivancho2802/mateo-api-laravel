            ...
            <section class="or-group-data or-branch disabled" name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante" data-relevant=" /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/tipo_persona_autorizacion  = 'menor_edad'">
              ...
              <?php if ($data['grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad']   == 'colombiano_a') { ?>
                ...
                <label class="question or-appearance-minimal or-branch"><span lang="" class="question-label active">Tipo de documento de identidad de la persona participante</span><span class="required">*</span>
                  <select name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idcolombia_mayor_edad" data-name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idcolombia_mayor_edad" data-required="true()" data-relevant=" /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/tipo_persona_autorizacion  = 'menor_edad' and  /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad  = 'colombiano_a'" data-type-xml="select1" style="display: none;">
                    <option class="itemset-template" value="" data-items-path="instance('tipo_idcolombia')/root/item[nacionalidad_mayor_edad= /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad ]">
                      ...</option>
                  ...
                  </div><span class="or-option-translations" style="display:none;"></span><span class="itemset-labels" data-value-ref="name" data-label-type="itext" data-label-ref="itextId"><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idcolombia-0">Cédula colombiana</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idcolombia-1">Tarjeta de
                      identidad</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idcolombia-2">Registro civil de nacimiento</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idcolombia-3">Pasaporte colombiano</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idcolombia-4">Certificado de
                      nacido/a vivo/a</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idcolombia-5">Acta de nacimiento</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idcolombia-6">Sin identificación</span>
                  </span><span class="or-required-msg active" lang="" data-i18n="constraint.required">Este campo es obligatorio</span>
                </label>
              ...
              <?php if ($data['grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad']   == 'venezolano_a') { ?>
                ...
                <label class="question or-appearance-minimal or-branch"><span lang="" class="question-label active">Tipo de documento de
                  ...
                  <select name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idvenezuela_mayor_edad" data-name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idvenezuela_mayor_edad" data-required="true()" data-relevant=" /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/tipo_persona_autorizacion  = 'menor_edad' and  /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad  = 'venezolano_a'" data-type-xml="select1" style="display: none;">
                    <option class="itemset-template" value="" data-items-path="instance('tipo_idvenezuela')/root/item[nacionalidad_mayor_edad= /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad ]">
                      ...</option>
                  ...
                  <div class="btn-group bootstrap-select widget clearfix">
                    ...
                    <ul class="dropdown-menu" role="menu">
                      ...
                      venezolano</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idvenezuela-2">Acta de nacimiento</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idvenezuela-3">Permiso Especial de Permanencia
                      (PEP)</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idvenezuela-4">Permiso Especial de Permanencia para el Fomento de la
                      Formalización (PFF)</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idvenezuela-5">Permiso de Ingreso y Permanencia (PIP)</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idvenezuela-6">Permiso Temporal de
                      Protección (PTP)</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idvenezuela-7">Permiso de Ingreso y Permanencia de Tránsito Temporal
                      (PIP-TT)</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idvenezuela-8">Tarjeta de movilidad fronteriza (TMF)</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idvenezuela-9">Carta Solicitante de
                      Refugio o Asilo</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idvenezuela-10">Visa</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idvenezuela-11">Sin identificación colombiana con documento
                      venezolano</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idvenezuela-12">Otro</span>
                  </span><span class="or-required-msg active" lang="" data-i18n="constraint.required">Este campo es obligatorio</span>
                </label>
              ...
              <?php if ($data['grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad']   == 'colombovenezolano') { ?>
                <label class="question or-appearance-minimal or-branch"><span lang="" class="question-label active">Tipo de documento de identidad de la persona participante</span><span class="required">*</span>
                  <select name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idbinacional_mayor_edad" data-name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idbinacional_mayor_edad" data-required="true()" data-relevant=" /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/tipo_persona_autorizacion  = 'menor_edad' and  /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad  = 'colombovenezolano'" data-type-xml="select1" style="display: none;">
                    <option class="itemset-template" value="" data-items-path="instance('tipo_idbinacional')/root/item[nacionalidad_mayor_edad= /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad ]">
                      ...</option>
                  ...
                  </div><span class="or-option-translations" style="display:none;"></span><span class="itemset-labels" data-value-ref="name" data-label-type="itext" data-label-ref="itextId"><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-0">Cédula colombiana</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-1">Tarjeta de
                      identidad</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-2">Registro civil de nacimiento</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-3">Certificado de nacido/a
                      vivo/a</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-4">Cédula de extranjería</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-5">Pasaporte venezolano</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-6">Acta de
                      nacimiento</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-7">Permiso Especial de Permanencia (PEP)</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-8">Permiso de Ingreso
                      y Permanencia (PIP)</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-9">Permiso Temporal de Protección (PTP)</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-10">Permiso de Ingreso
                      y Permanencia de Tránsito Temporal (PIP-TT)</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-11">Tarjeta de movilidad fronteriza (TMF)</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-12">Carta Solicitante
                      de Refugio o Asilo</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-13">Visa</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-14">Otro tipo de identificación</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-15">Sin identificación colombiana con
                      documento venezolano</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-16">Sin identificación</span><span lang="default" class="option-label active" data-itext-id="static_instance-tipo_idbinacional-17">Otro</span>
                  </span><span class="or-required-msg active" lang="" data-i18n="constraint.required">Este campo es obligatorio</span>
                </label>
              <?php } ?>
              ...
              <?php if ($data['grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad']   == 'otra_nacionalidad') { ?>
                ...
                <fieldset class="question simple-select or-branch disabled" disabled="">
                  <fieldset>
                    ...
                    <div class="option-wrapper"><label class="">
                        <input type="radio" name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad" data-name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad" value="pasaporte_7" {{isset($data['grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad']) && $data['grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad']=="pasaporte_7" ? "checked": ""}} data-required="true()" data-relevant=" /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/tipo_persona_autorizacion  = 'menor_edad' and  /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad  = 'otra_nacionalidad'" data-type-xml="select1"><span lang="" class="option-label active">Pasaporte</span></label><label class="">
                        <input type="radio" name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad" data-name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad" value="cedula_extranjera" {{isset($data['grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad']) && $data['grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad']=="cedula_extranjera" ? "checked": ""}} data-required="true()" data-relevant=" /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/tipo_persona_autorizacion  = 'menor_edad' and  /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad  = 'otra_nacionalidad'" data-type-xml="select1"><span lang="" class="option-label active">Cédula de extranjería</span></label><label class="">
                        <input type="radio" name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad" data-name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad" value="visa" {{isset($data['grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad']) && $data['grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad']=="visa" ? "checked": ""}} data-required="true()" data-relevant=" /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/tipo_persona_autorizacion  = 'menor_edad' and  /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad  = 'otra_nacionalidad'" data-type-xml="select1"><span lang="" class="option-label active">Visa</span></label><label class="">
                        <input type="radio" name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad" data-name="/a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad" value="otro_id_4" {{isset($data['grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad']) && $data['grupo_datos_beneficiario/datos_participante/tipo_idnacionalidad_mayor_edad']=="otro_id_4" ? "checked": ""}} data-required="true()" data-relevant=" /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/tipo_persona_autorizacion  = 'menor_edad' and  /a4E3J9gkULZe5eRqQph8zh/grupo_datos_beneficiario/datos_participante/nacionalidad_mayor_edad  = 'otra_nacionalidad'" data-type-xml="select1"><span lang="" class="option-label active">Otro</span></label></div>
          ...
          <section class="or-group or-branch or-appearance-field-list" name="/a4E3J9gkULZe5eRqQph8zh/group_ww55p84" data-relevant=" /a4E3J9gkULZe5eRqQph8zh/autorizacion_acuerdo/autorizacion_tratamiento_de_datos  = 'si' and  /a4E3J9gkULZe5eRqQph8zh/autorizacion_acuerdo/autorizacion_uso_fotografias  = 'si'">
            ...
            <label class="question non-select with-media clearfix print-width-adjusted print-height-adjusted" style="width: 100%; height: 394px;">
              ...
              <div class="widget file-picker">
                ...
                <div class="file-feedback "></div>
                <div class="file-preview">
                  <img src="{{ ($data['group_ww55p84/imagen_documento_identidad_lado2']) ?? ''}}">
                </div>
              </div>
              <span class="or-required-msg active" lang="" data-i18n="constraint.required">Este campo es obligatorio</span>
            </label>
