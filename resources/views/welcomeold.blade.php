...
<body class="antialiased">
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    ...
    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
      @auth
      <a href="{{ route('dashboard', [], false) }}"  class="text-sm text-gray-700 underline">Dashboard</a>
      @else
      <a href="{{ route('login', [], false) }}" class="text-sm text-gray-700 underline">Login</a>

      @if (Route::has('register'))
      <a href="{{ route('register', [], false) }}"  class="ml-4 text-sm text-gray-700 underline">Register</a>
      @endif
      @endif
    </div>
    @endif
              ...
              <div class="flex items-center">
                ...
                <div class="ml-4 text-lg leading-7 font-semibold">
                  <a href="{{ route('koboactivityinfo') }}" class="underline text-gray-900 dark:text-white">
                    Esta herramienta funciona trnsferir kobo a activity info
                  </a>
                </div>
              </div>
