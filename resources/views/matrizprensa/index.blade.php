                ...
                <div class="relative border-b border-gray-200 py-6" x-data="{ isOpen: false }">
                  ...
                  <div class="pt-6" id="filter-section-0" x-show="isOpen">
                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                      ...
                      <form method="post" action="http://localhost:3000/generate-founts" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                        @csrf
                ...
                <div class="border-b border-gray-200 py-6" x-data="{ isOpenB: false }">
                  ...
                  <div class="pt-6" id="filter-section-1" x-show="isOpenB">
                    <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                      ...
                      <form method="post" action="http://localhost:3000/generate-founts-lite" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
