...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center pt-8 sm:justify-center sm:pt-0 bg-white ">
                <img src="http://ach.dyndns.info:6080/webMIRE/images/Bandera_Logos_MIRE.png" class="h-16 w-auto text-gray-700 sm:h-20" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            <img src="http://ach.dyndns.info:6080/webMIRE/images/MIREsys4.jpg" class="w-8 h-8 text-gray-500" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Servicio para obtener datos de un formulario kobo con labes</div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                Esta herramienta funciona para generar la misma informacion de un kobo pero con sus header o titulos de columnas de una mejro forma como se ve en los labes 
                                <br>
                                Formato url para importar en excel o en powe bi
                                <br>

                                http://ach.dyndns.info:6180/api/kobo/[asset_uid]/data/[token]
                                <br>
                                ...
                                ademas de poner el token en la url debes poner el token de la api MIREsys para acceder a los datos
                                <br>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                http://ach.dyndns.info:6180/api/matriz/minas
