    ...
    @endif
      ...
      <div class="mt-2 bg-white light:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-1">
          ...
          <!-- textos de abajo -->
          <div class="row pt-4 text-sm" style="width:100%">
            @foreach ($pregunt as $key3 => $preg)
              <div class=" {{$key3 == 0 || $key3 == 4 ? 'col text-center' : 'col text-center'}}"  style="width:20%">
                {{$preg[0]}}
              </div>
            @endforeach
          </div>
        </div>
        <div class="col-2 text-right text-bold"  style="    font-size: 0.8em;">
          {{$pregunt[0][5]}}
        </div>
      </div>
