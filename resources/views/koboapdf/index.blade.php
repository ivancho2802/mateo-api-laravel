                  ...
                  <!-- <div class="pt-6" id="filter-section-0" x-show="isOpen">
                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                      ...
                      <form method="post" action="{{ route('job/deploy/exportkobo') }}" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                        ...
                        <div>ejemplo: 322f65e3677ee93aa3... se obtiene visitando https://kobo2.actioncontrelafaim.org/token/?format=json o el que corresponda a su dominio</div>
                        <br>
                        ...
                        <li>
                          <div class="flex items-center gap-x-6">
                            ...
                            <div>
                              ...
                              <form method="get" action="{{ route('koboapdfactualizar', ['idjobdetail' => optional($export)->name_key ?? optional($export)->formid]) }}" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                                @csrf
