...
(
    ...
    0 AS "VALOR5",'OIR' AS "ROTULO" FROM (
        ...
        GROUP BY 
            "DISCAPACIDAD_OIR" 
        HAVING
            "DISCAPACIDAD_OIR" = 'Si - Alguna dificultad' or "DISCAPACIDAD_OIR" = 'Si - Mucha dificultad'
    ) AS G
)
UNION
(
    ...
    0 AS "VALOR5", 'VER' AS "ROTULO" FROM (
		...
		GROUP BY 
			"DISCAPACIDAD_VER" 
		HAVING
			"DISCAPACIDAD_VER" = 'Si - Alguna dificultad' or "DISCAPACIDAD_VER" = 'Si - Mucha dificultad' or "DISCAPACIDAD_VER" = 'Si - No puede hacerlo'
	) AS A
)
UNION
(
    ...
    0 AS "VALOR5", 'CAMINAR' AS "ROTULO" FROM (
		...
		HAVING
			"DISCAPACIDAD_CAMINAR" = 'Si - No puede hacerlo' or "DISCAPACIDAD_CAMINAR" = 'Si - Alguna dificultad' or "DISCAPACIDAD_CAMINAR" = 'Si - Mucha dificultad'
	) AS B
) 
UNION
(
...
(
    ...
    0 AS "VALOR5", 'RECORDAR' AS "ROTULO" FROM (
		...
		HAVING
			"DISCAPACIDAD_RECORDAR" = 'Si - Alguna dificultad' or "DISCAPACIDAD_RECORDAR" = 'Si - Mucha dificultad'
	) AS B
)
UNION
(
    ...
    0 AS "VALOR5", 'CUIDADO' AS "ROTULO" FROM (
		...
		HAVING
			"DISCAPACIDAD_CUIDADO_PROPIO" = 'Si - Alguna dificultad' or "DISCAPACIDAD_CUIDADO_PROPIO" = 'Si - Mucha dificultad'
	) AS B
)
UNION
(
    ...
    0 AS "VALOR5", 'COMUNICAR' AS "ROTULO" FROM (
		...
		HAVING
			"DISCAPACIDAD_COMUNICAR" = 'Si - Alguna dificultad' or "DISCAPACIDAD_COMUNICAR" = 'Si - Mucha dificultad'
	) AS B
)
