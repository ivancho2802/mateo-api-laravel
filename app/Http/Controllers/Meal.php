...
class Meal extends Controller
{
    ...
    function getLpaOnlyPage(Request $request)
    {
        ...
        $num_pages = ceil(count($mlpas_origin->get()) / 10); //where("FECHA_ATENCION", ">=", "2023-01-01")limit(60000)->
    ...
    function getLpa(Request $request)
    {
        ...
        if ($request->pagination) {
            ...
            $mlpas = $mlpasBase->orderBy('ID', 'desc')->paginate(10);//->cursorPaginate(10);
    ...
    public function getLpaMigrations(Request $request)
    {
