...
class Alertas extends Controller
{
    ...
    function allFirebirdNumFamiHogares(Request $request){
        ...
        $resultados = DB::select("SELECT codigo, M_KOBO_FORMULARIOS.DEPARTAMENTO dpto, M_KOBO_FORMULARIOS.MUNICIPIO municip, cast(cast(TIPO_EMERG as blob sub_type text character set ISO8859_1) as varchar(2000)) TIPO_EMERG, cast(cast(HECHO_VICTIMIZANTE as blob sub_type text character set ISO8859_1) as varchar(2000)) HECHO_VICTIMIZANTE, cast(cast(FECHA_EVENTO as blob sub_type text character set ISO8859_1) as varchar(2000))FECHA_EVENTO, cast(cast(fECHA_INICIO_ERN as blob sub_type text character set ISO8859_1) as varchar(2000))fECHA_INICIO_ERN, cast(cast(FECHA_FIN_ERN as blob sub_type text character set ISO8859_1) as varchar(2000))FECHA_FIN_ERN, cast(cast(BRECHAS_ERN as blob sub_type text character set ISO8859_1) as varchar(2000))BRECHAS_ERN, cast(cast(NUM_FAMILIAS as blob sub_type text character set ISO8859_1) as varchar(2000))NUM_FAMILIAS, cast(cast(M_KOBO_RESPUESTAS.XVALOR as blob sub_type text character set ISO8859_1) as varchar(2000)) NUM_PERSONAS FROM( SELECT IDFORM, codigo, M_KOBO_FORMULARIOS.DEPARTAMENTO dpto, M_KOBO_FORMULARIOS.MUNICIPIO municip, TIPO_EMERG,HECHO_VICTIMIZANTE,FECHA_EVENTO, fECHA_INICIO_ERN,FECHA_FIN_ERN,BRECHAS_ERN,  M_KOBO_RESPUESTAS.XVALOR NUM_FAMILIAS FROM( SELECT IDFORM, codigo, M_KOBO_FORMULARIOS.DEPARTAMENTO dpto, M_KOBO_FORMULARIOS.MUNICIPIO municip, TIPO_EMERG, M_KOBO_RESPUESTAS.XVALOR HECHO_VICTIMIZANTE,FECHA_EVENTO, fECHA_INICIO_ERN,FECHA_FIN_ERN,BRECHAS_ERN FROM( SELECT IDFORM, codigo, M_KOBO_FORMULARIOS.DEPARTAMENTO dpto, M_KOBO_FORMULARIOS.MUNICIPIO municip, TIPO_EMERG, FECHA_EVENTO, fECHA_INICIO_ERN,M_KOBO_RESPUESTAS.XVALOR BRECHAS_ERN, FECHA_FIN_ERN FROM( SELECT IDFORM,codigo, M_KOBO_FORMULARIOS.DEPARTAMENTO dpto, M_KOBO_FORMULARIOS.MUNICIPIO municip, TIPO_EMERG, FECHA_EVENTO, fECHA_INICIO_ERN,M_KOBO_RESPUESTAS.XVALOR FECHA_FIN_ERN FROM(      SELECT codigo, TIPO_EMERG, FECHA_EVENTO, M_KOBO_RESPUESTAS.XVALOR FECHA_INICIO_ERN, IDFORM      FROM (           SELECT TIPO_EMERG,codigo, M_KOBO_RESPUESTAS.XVALOR FECHA_EVENTO,IDFORM           from (                SELECT M_KOBO_RESPUESTAS.XVALOR TIPO_EMERG,m_kobo_formularios.xCODIGO_ALERTA codigo,                M_KOBO_FORMULARIOS.ID_M_KOBO_FORMULARIOS IDFORM                FROM M_KOBO_RESPUESTAS INNER JOIN M_KOBO_FORMULARIOS                ON M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS=M_KOBO_FORMULARIOS.ID_M_KOBO_FORMULARIOS                WHERE M_KOBO_RESPUESTAS.ID_P_FORMULARIOS='001238' AND M_KOBO_FORMULARIOS.ESTATUS<>'ANULADO')           inner join M_KOBO_RESPUESTAS on M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS=IDFORM           WHERE M_KOBO_RESPUESTAS.ID_P_FORMULARIOS='001253')      INNER JOIN M_KOBO_RESPUESTAS on M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS=IDFORM      WHERE M_KOBO_RESPUESTAS.ID_P_FORMULARIOS='001198') INNER JOIN M_KOBO_RESPUESTAS on M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS=IDFORM INNER JOIN M_KOBO_FORMULARIOS ON M_KOBO_FORMULARIOS.ID_M_KOBO_FORMULARIOS=M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS WHERE M_KOBO_RESPUESTAS.ID_P_FORMULARIOS='001721') INNER JOIN M_KOBO_RESPUESTAS on M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS=IDFORM INNER JOIN M_KOBO_FORMULARIOS ON M_KOBO_FORMULARIOS.ID_M_KOBO_FORMULARIOS=M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS WHERE M_KOBO_RESPUESTAS.ID_P_FORMULARIOS='001313') INNER JOIN M_KOBO_RESPUESTAS on M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS=IDFORM INNER JOIN M_KOBO_FORMULARIOS ON M_KOBO_FORMULARIOS.ID_M_KOBO_FORMULARIOS=M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS WHERE M_KOBO_RESPUESTAS.ID_P_FORMULARIOS='001285') INNER JOIN M_KOBO_RESPUESTAS on M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS=IDFORM INNER JOIN M_KOBO_FORMULARIOS ON M_KOBO_FORMULARIOS.ID_M_KOBO_FORMULARIOS=M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS WHERE M_KOBO_RESPUESTAS.ID_P_FORMULARIOS='001292') INNER JOIN M_KOBO_RESPUESTAS on M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS=IDFORM INNER JOIN M_KOBO_FORMULARIOS ON M_KOBO_FORMULARIOS.ID_M_KOBO_FORMULARIOS=M_KOBO_RESPUESTAS.ID_M_KOBO_FORMULARIOS WHERE M_KOBO_RESPUESTAS.ID_P_FORMULARIOS='001293' ");
