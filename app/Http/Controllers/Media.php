    ...
    $preguntas = collect([
      "¿Qué es?: Definición" => [
        ...
        "Tipos de transición" => [ // 1.2.1 Frente a estas afirmaciones en cuál se siente más representado
          " “La transición debe ser una ruptura profunda con el modelo actual, para restaurar el equilibrio del planeta y detener el colapso ecológico.”>Transición como restauración ecológica>PRESERVACIÓN  AMBIENTAL >JUSTICIA SOCIAL",  //	10	10: Restauración ambiental 50: Justicia social
        ...
        "Ritmo" => [ //1.3.1 Frente a estas afirmaciones en cuál se siente más representado
          "“La transición debe comenzar ya, antes de que los daños al planeta sean irreversibles.”>Urgencia ecológica inmediata>INMEDIATO>GRADUAL", //.	10	10: Inmediato 50: Gradual
        ...
        "Escala" => [ //	1.4.1 Frente a estas afirmaciones en cuál se siente más representado
          "“La transición debe abordarse desde una perspectiva global, ya que los efectos y soluciones del cambio climático trascienden fronteras.”>Escala global>GLOBAL>LOCAL", //	10	10: Global 50: Local
      ...
      "¿Quiénes?:  Actores" => [
        "Actores involucrados" => [ //	2.1.1 Frente a estas afirmaciones en cuál se siente más representado
          " La transición solo es posible si todos los actores —gobiernos, empresas, comunidades, organizaciones y academia— participan de forma activa y con responsabilidades compartidas.>Multiactor integral>MULTIACTOR>ACTOR ÚNICO", //  	10	10: Multiactor50: Actor único 
        ...
        "Rol Estado" => [ //  	2.2.1 Frente a estas afirmaciones en cuál se siente más representado
          "El Estado debe limitarse a generar las condiciones básicas para que otros actores —como el mercado, la sociedad civil o las comunidades— lideren los procesos de transición.>Facilitar condiciones generales>ROL MÍNIMO>LIDERAZGO ", //	10	10: Rol minimo 50: Protagonismo
        ...
        "Rol Empresas" => [ // 	2.3.1 Frente a estas afirmaciones en cuál se siente más representado
          " “Las empresas deben limitarse a cumplir regulaciones; no pueden liderar la transición porque sus intereses económicos no siempre se alinean con el bien común.”>Participación solo enmarcada en cumplimiento marco>ROL MINIMO>LIDERAZGO ", //.	10	10: Rol minimo 50: Protagonismo
        ...
        "Rol Comunidades" => [ //	2.4.1 Frente a estas afirmaciones en cuál se siente más representado
          "“Las comunidades deben adaptarse a los planes definidos por expertos, gobiernos o empresas, ya que no tienen la capacidad técnica para liderar procesos complejos.”>Receptoras pasivas>ROL MINIMO>LIDERAZGO ", //.	10	10: Rol minimo 50: Protagonismo
        ...
        "OSC" => [ //	2.5.1 Frente a estas afirmaciones en cuál se siente más representado
          "“Las organizaciones de la sociedad civil pueden opinar o acompañar, pero no deben interferir en las decisiones técnicas o de gobierno sobre la transición.”>Acompañamiento>ROL MINIMO>LIDERAZGO ", //.	10	10: Rol minimo 50: Protagonismo
      ...
      "¿Cómo?: Proceso" => [
        ...
        "Espacios" => [ //3.2.1  Frente a estas afirmaciones en cuál se siente más representado
          "“Los espacios institucionales actuales —gobiernos, organismos multilaterales, foros técnicos— ya tienen la legitimidad y capacidad para liderar la transición.”>Confianza plena en espacios >CONFIANZA ESPACIOS ACTUALES>NECESIDAD NUEVOS ESPACIOS ", //.	10	10: Confianza en espacios actuales 50: Necesidad de  nuevos espacios
        ...
        "Marcos" => [ //3.3.1  Frente a estas afirmaciones en cuál se siente más representado
          "“Ya existen los tratados, leyes y políticas necesarios para impulsar la transición; lo que falta es voluntad y aplicación efectiva.”>Confianza plena en marcos actuales>CONFIANZA MARCOS ACTUALES>NECESIDAD NUEVOS MARCOS", //. 	10	10: Confianza en marcos actuales 50: Necesidad de nuevos marcos
        ...
        "Colaboración" => [ //3.4.1  Frente a estas afirmaciones en cuál se siente más representado
          "“En un proceso de transición como el que vivimos, es imposible colaborar. Cada actor busca lo suyo y no hay confianza para trabajar juntos.”>Negación>BAJA>ALTA ", //.	10	10: Interdependencia 50: Soberania
    ...
    $preguntapuesta = $preguntas->map(function ($pregunta) {
      $pregunta_ = collect($pregunta)->map(function ($pregunt) {
        ...
        $preguntapuesta_ = collect($pregunt)->map(function ($preg) use ($limitinferior, $limitsuperior) {
          ...
          $arraycount = [$frase[1], $percentageOptionA, $frase[0], $conteo, $limitinferior, $limitsuperior];
          /* } */
          //frase & count
          return $arraycount;
        });
