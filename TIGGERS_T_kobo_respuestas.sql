...
CREATE TRIGGER T_KOBO_RESPUESTAS FOR TMP_RESPUESTAS
...
DECLARE VARIABLE XESTATUS VARCHAR(20);
DECLARE VARIABLE XROTULO VARCHAR(5000);
DECLARE VARIABLE XID_P_FORMULARIOS VARCHAR(1000);
BEGIN
--/*
     SELECT ESTATUS
     FROM M_FORMULARIOS
     ...
     BEGIN
          ...
          ROTULO, VALOR_C, VALOR_N, VALOR, REFERENCIA, ESTATUS, UID, FUID)
          VALUES(NEW.ID_TMP_RESPUESTAS, NEW.ID_M_KOBO_FORMULARIOS, NEW.ID_M_FORMULARIOS, NEW.ID_P_FORMULARIOS, NEW.TIPO,
          NEW.ROTULO, NEW.VALOR_C, NEW.VALOR_N, NEW.VALOR, NEW.REFERENCIA, NEW.ESTATUS, NEW.UID, NEW.FUID)
          RETURNING ID_M_KOBO_RESPUESTAS INTO NEW.ID_M_KOBO_RESPUESTAS;
          
          IF(NEW.ID_M_FORMULARIOS=0014 AND NEW.ID_P_FORMULARIOS IS NULL AND NEW.ID_M_KOBO_RESPUESTAS IS NOT NULL) THEN
          BEGIN
               ...
               VALUES ( NEW.ID_P_FORMULARIOS, NEW.ID_M_FORMULARIOS, NEW.REFERENCIA, 'C', 'NOW', 'I', -1, '001', NEW.VALOR_C, 'NOW', NEW.ESTATUS, 1, NEW.REFERENCIA, NEW.VALOR_C, NEW.VALOR_N)
               RETURNING ID_P_FORMULARIOS
               INTO XID_P_FORMULARIOS;
               
               UPDATE M_KOBO_RESPUESTAS SET ID_P_FORMULARIOS = :XID_P_FORMULARIOS
               WHERE ID_M_KOBO_RESPUESTAS = NEW.ID_M_KOBO_RESPUESTAS;
