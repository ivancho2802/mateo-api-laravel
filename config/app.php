...
return [
    ...
    */
    ...
    'matrizSqlGraficos' => [
        ...
        //DISCAPACIDAD
        '00147' => "(    SELECT SUM(NUM_SORDOS) AS \"VALOR1\",    0 AS \"VALOR2\",     0 AS \"VALOR3\",     0 AS \"VALOR4\",     0 AS \"VALOR5\",'OIR' AS \"ROTULO\" FROM (        SELECT             (COUNT(\"DISCAPACIDAD_OIR\"))as NUM_SORDOS        FROM        	\"M_LPA_PERSONAS\"        JOIN \"M_LPAS\" ON (\"M_LPAS\".\"FK_LPA_PERSONA\" = \"M_LPA_PERSONAS\".\"ID\")                 GROUP BY             \"DISCAPACIDAD_OIR\"         HAVING            \"DISCAPACIDAD_OIR\" = 'Si - Alguna dificultad' or \"DISCAPACIDAD_OIR\" = 'Si - Mucha dificultad'    ) AS G ) UNION ( 	SELECT SUM(NUM_CIEGOS) AS \"VALOR1\",    0 AS \"VALOR2\",     0 AS \"VALOR3\",     0 AS \"VALOR4\",     0 AS \"VALOR5\", 'VER' AS \"ROTULO\" FROM ( 		SELECT  			(COUNT(\"DISCAPACIDAD_VER\"))as NUM_CIEGOS 		FROM        \"M_LPA_PERSONAS\"        JOIN \"M_LPAS\" ON (\"M_LPAS\".\"FK_LPA_PERSONA\" = \"M_LPA_PERSONAS\".\"ID\")          		 		GROUP BY  			\"DISCAPACIDAD_VER\"  		HAVING 			\"DISCAPACIDAD_VER\" = 'Si - Alguna dificultad' or \"DISCAPACIDAD_VER\" = 'Si - Mucha dificultad' or \"DISCAPACIDAD_VER\" = 'Si - No puede hacerlo' 	) AS A ) UNION ( 	SELECT SUM(NUM_COJOS) AS \"VALOR1\",    0 AS \"VALOR2\",     0 AS \"VALOR3\",     0 AS \"VALOR4\",     0 AS \"VALOR5\", 'CAMINAR' AS \"ROTULO\" FROM ( 		SELECT  			(COUNT(\"DISCAPACIDAD_CAMINAR\"))as NUM_COJOS 		FROM        	\"M_LPA_PERSONAS\"         JOIN \"M_LPAS\" ON (\"M_LPAS\".\"FK_LPA_PERSONA\" = \"M_LPA_PERSONAS\".\"ID\") 		GROUP BY  			\"DISCAPACIDAD_CAMINAR\"  		HAVING 			\"DISCAPACIDAD_CAMINAR\" = 'Si - No puede hacerlo' or \"DISCAPACIDAD_CAMINAR\" = 'Si - Alguna dificultad' or \"DISCAPACIDAD_CAMINAR\" = 'Si - Mucha dificultad' 	) AS B )  UNION ( 	SELECT SUM(NUM_COJOS) AS \"VALOR1\",    0 AS \"VALOR2\",     0 AS \"VALOR3\",     0 AS \"VALOR4\",     0 AS \"VALOR5\", 'CAMINAR' AS \"ROTULO\" FROM ( 		SELECT  			(COUNT(\"DISCAPACIDAD_CAMINAR\"))as NUM_COJOS 		FROM        	\"M_LPA_PERSONAS\"         JOIN \"M_LPAS\" ON (\"M_LPAS\".\"FK_LPA_PERSONA\" = \"M_LPA_PERSONAS\".\"ID\") 		GROUP BY  			\"DISCAPACIDAD_CAMINAR\"  		HAVING 			\"DISCAPACIDAD_CAMINAR\" = 'Si - No puede hacerlo' or \"DISCAPACIDAD_CAMINAR\" = 'Si - Alguna dificultad' or \"DISCAPACIDAD_CAMINAR\" = 'Si - Mucha dificultad' 	) AS B )  UNION ( 	SELECT SUM(NUM_AMNESICOS) AS \"VALOR1\",    0 AS \"VALOR2\",     0 AS \"VALOR3\",     0 AS \"VALOR4\",     0 AS \"VALOR5\", 'RECORDAR' AS \"ROTULO\" FROM ( 		SELECT  			(COUNT(\"DISCAPACIDAD_RECORDAR\"))as NUM_AMNESICOS 		FROM        	\"M_LPA_PERSONAS\"         JOIN \"M_LPAS\" ON (\"M_LPAS\".\"FK_LPA_PERSONA\" = \"M_LPA_PERSONAS\".\"ID\") 		GROUP BY  			\"DISCAPACIDAD_RECORDAR\"  		HAVING 			\"DISCAPACIDAD_RECORDAR\" = 'Si - Alguna dificultad' or \"DISCAPACIDAD_RECORDAR\" = 'Si - Mucha dificultad' 	) AS B ) UNION ( 	SELECT SUM(NUM_DESCUIDADOS) AS \"VALOR1\",    0 AS \"VALOR2\",     0 AS \"VALOR3\",     0 AS \"VALOR4\",     0 AS \"VALOR5\", 'CUIDADO' AS \"ROTULO\" FROM ( 		SELECT  			(COUNT(\"DISCAPACIDAD_CUIDADO_PROPIO\"))as NUM_DESCUIDADOS 		FROM        	\"M_LPA_PERSONAS\"         JOIN \"M_LPAS\" ON (\"M_LPAS\".\"FK_LPA_PERSONA\" = \"M_LPA_PERSONAS\".\"ID\") 		GROUP BY  			\"DISCAPACIDAD_CUIDADO_PROPIO\"  		HAVING 			\"DISCAPACIDAD_CUIDADO_PROPIO\" = 'Si - Alguna dificultad' or \"DISCAPACIDAD_CUIDADO_PROPIO\" = 'Si - Mucha dificultad' 	) AS B ) UNION ( 	SELECT SUM(NUM_COMUNICAR) AS \"VALOR1\",    0 AS \"VALOR2\",     0 AS \"VALOR3\",     0 AS \"VALOR4\",     0 AS \"VALOR5\", 'COMUNICAR' AS \"ROTULO\" FROM ( 		SELECT  			(COUNT(\"DISCAPACIDAD_COMUNICAR\"))as NUM_COMUNICAR 		FROM        	\"M_LPA_PERSONAS\"         JOIN \"M_LPAS\" ON (\"M_LPAS\".\"FK_LPA_PERSONA\" = \"M_LPA_PERSONAS\".\"ID\") 		GROUP BY  			\"DISCAPACIDAD_COMUNICAR\"  		HAVING 			\"DISCAPACIDAD_COMUNICAR\" = 'Si - Alguna dificultad' or \"DISCAPACIDAD_COMUNICAR\" = 'Si - Mucha dificultad' 	) AS B )",
