...
return [
    ...
    */
    ...
    'matrizSqlGraficos' => [
        ...
        '00143' => "SELECT      \"ROTULO\",      COUNT(1) AS \"VALOR1\",     0 AS \"VALOR2\",      0 AS \"VALOR3\",      0 AS \"VALOR4\",      0 AS \"VALOR5\"  FROM(     SELECT          \"M_LPA_EMERGENCIAS\".\"SOCIO\" AS \"ROTULO\",         \"M_LPAS\".\"FK_LPA_PERSONA\" AS \"TIPO_IDENTIF\",              \"M_LPA_PERSONAS\".\"TIPO_DOCUMENTO\" AS \"NOMBRE_TIPO_IDENTIF\",           \"M_LPA_PERSONAS\".\"DOCUMENTO\" AS \"NUM_IDENTIF\"      FROM \"M_LPAS\"     LEFT JOIN \"M_LPA_PERSONAS\" ON (\"M_LPA_PERSONAS\".\"ID\" = \"M_LPAS\".\"FK_LPA_PERSONA\")      LEFT JOIN \"M_LPA_EMERGENCIAS\" ON (\"M_LPA_EMERGENCIAS\".\"ID\" = \"M_LPAS\".\"FK_LPA_EMERGENCIA\")      WHERE \"M_LPAS\".\"FECHA_ATENCION\" '{FECHA_DESDE}' AND '{FECHA_HASTA}' AND                          \"M_LPA_EMERGENCIAS\".\"DEPARTAMENTO\" LIKE '%{CONDICION1}%'      GROUP BY          \"ROTULO\",\"TIPO_IDENTIF\",\"NOMBRE_TIPO_IDENTIF\",\"NUM_IDENTIF\" )as x  GROUP BY \"ROTULO\"        ",
