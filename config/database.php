    ...
    */
    ...
    'connections' => [
        ...
        'pgsql-ugo-hp' => [
            ...
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '5432'),
            'database' => env('DB_DATABASE', 'ach_restore'),
            'username' => env('DB_USERNAME', 'SYSDBA'),
            'password' => env('DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
        ...
        'firebird' => [
            'driver'   => 'firebird',
            'host'     => env('DB_FIREBIRD_DB_HOST', '192.168.100.152'),
        ...
        'odbc' => [
            'driver' => 'odbc', //
            'dsn' => 'Driver={Devart ODBC Driver for Firebird};Database=192.168.100.152/3050:/opt/lampp/firebird/db/ach.gdb',
            //'grammar' => 'DB2',
            'username' => 'SYSDBA',
            'password' => 'masterkey',
            'database' => 'ach',
